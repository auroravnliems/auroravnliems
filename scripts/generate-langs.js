...
const USERNAME = process.argv[2] || process.env.INPUT_USERNAME || (process.env.GITHUB_REPOSITORY ? process.env.GITHUB_REPOSITORY.split('/')[0] : 'auroravnliems');
...
function makeSvg(langArray, totalBytes) {
  ...
  // Aurora-themed colors: Java orange, Kotlin purple, then others
  const colors = [
    '#ED8B00', '#7F52FF', '#F97316', '#3B82F6', '#10B981',
    '#06B6D4', '#EF4444', '#8B5CF6', '#EC4899', '#94A3B8'
  ];
